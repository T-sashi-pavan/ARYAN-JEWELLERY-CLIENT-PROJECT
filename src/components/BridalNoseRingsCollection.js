    ...
    <div className="bridal-collection-page">
      <div className="container">
        ...
        <div className="collection-header">
          <h2 className="collection-title">Bridal Nose Rings Collection</h2>
          <p className="collection-description">
            Complete your bridal look with our exquisite nose rings, crafted with traditional designs and premium materials.
          </p>
        </div>
